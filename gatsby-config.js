...
module.exports = {
  siteMetadata: {
    siteTitleAlt: `Cemût - Piccola Osteria Furlana`,
  },
  plugins: [
    {
      ...
      options: {
        navigation: [
          { name: `Dove siamo`, slug: `/projects` },
          { name: `Collab`, slug: `/art` },
          { name: `Chi siamo`, slug: `/about` },
        ],
      },
    },
    {
    ...
    `gatsby-plugin-sitemap`,
    {
      ...
      options: {
        name: `Cemût - Piccola Osteria Furlana`,
        short_name: `Cemût`,
